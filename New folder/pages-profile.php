                        ...
                        <div class="col-xl-4 col-lg-5">
                            <div class="card text-center">
                                <div class="card-body">
                                    ...
                                    <h4 class="mb-1 mt-2"><?php echo $nama; ?></h4>
                                    ...
                                    <div class="text-start mt-3">
                                        ...
                                        <p class="text-muted mb-2"><strong>Full Name :</strong> <span class="ms-2"><?php echo $nama; ?></span></p>

                                        <p class="text-muted mb-2"><strong>Mobile :</strong><span class="ms-2"></span></p>

                                        <p class="text-muted mb-2"><strong>Email :</strong> <span class="ms-2 "><?php echo $email; ?></span></p>

                                        <p class="text-muted mb-1"><strong>Location :</strong> <span class="ms-2"></span></p>
                                    </div>
