                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Tukar Hari Libur</li>
                                    </ol>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <nav id="navbar-example2" class="navbar navbar-light bg-light px-3">
                                            <a class="navbar-brand" href="#"><font color="#EC008C"><strong>History Tukar Hari Libur</strong></font>
                                        </nav><br>
                                    ...
                                    <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>NIP</th>
                                                <th>Nama</th>
                                                <th>Tanggal Libur Semula</th>
                                                <th>Tanggal Libur Menjadi</th>
                                                <th>Total Saldo Hingga Saat Ini</th>
												<th>Tgl Approval</th>
												<th>Action</th>
                                            </tr>
                                        </thead>
