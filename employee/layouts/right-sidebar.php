                ...
                <ul class="sidebar-links" id="simple-bar">
                  ...
                  <li class="menu-box"> 
                    <ul>
					  ...
					  <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="../user/permohonan-karyawan.php"><i data-feather="folder-plus"> </i><span>Permohonan Karyawan</span></a></li>
                    </ul>
                  </li>
                  <li class="sidebar-main-title">          
