...
include '../../layouts/koneksi.php';
        ...
        <body>
          ...
          ?>
                                    ...
                                    <div class="card" id="employee-details">
                                        ...
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <table class="table table-striped">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td><?php echo isset($data['EmployeeID']) ? $data['EmployeeID'] : ""; ?></td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">Employee Name</th>
                                                            <td><?php echo isset($data['EmployeeName']) ? $data['EmployeeName'] : ""; ?></td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">Organization Code</th>
                                                            <td><?php echo isset($data['OrganizationCode']) ? $data['OrganizationCode'] : ""; ?></td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">Organization Name</th>
                                                            <td><?php echo isset($data['OrganizationName']) ? $data['OrganizationName'] : ""; ?></td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">Position ID</th>
                                                            <td><?php echo isset($data['Posid']) ? $data['Posid'] : ""; ?></td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">Position Name</th>
                                                            <td><?php echo isset($data['PositionName']) ? $data['PositionName'] : ""; ?></td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">Level Code</th>
                                                            <td><?php echo isset($data['LevelID']) ? $data['LevelID'] : ""; ?></td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">Organization Level</th>
                                                            <td><?php echo isset($data['OrgLevel']) ? $data['OrgLevel'] : ""; ?></td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">Birth Date</th>
                                                            <td><?php echo isset($data['BirthDate']) ? $data['BirthDate'] : ""; ?></td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">Join Date</th>
                                                            <td><?php echo isset($data['JoinDate']) ? $data['JoinDate'] : ""; ?></td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">Employment Type</th>
                                                            <td><?php echo isset($data['EmploymentType']) ? $data['EmploymentType'] : ""; ?></td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">Status Employee</th>
                                                            <td><?php echo isset($data['StatusEmployee']) ? $data['StatusEmployee'] : ""; ?></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                                ...
                                                <button class="btn btn-primary btn-sm mb-3" onclick="printEmployeeDetails()">Print PDF</button>
                                                <!-- Tombol untuk kembali ke halaman sebelumnya -->
                                                <button class="btn btn-secondary btn-sm mb-3" onclick="goBack()">Back</button>
                                                <!-- Tombol Edit -->
                                                <button class="btn btn-success btn-sm mb-3" id="editButton" onclick="showEditModal()">Edit</button>
                                                <!-- Tombol Resign -->
                                                <button class="btn btn-warning btn-sm mb-3" id="resignButton" onclick="showResignModal()">Resign</button>
                                                <!-- Tombol Hapus -->
                                                <button class="btn btn-danger btn-sm mb-3" onclick="showDeleteModal()">Hapus</button>
            ...
            <script>
                function goBack() {
                    window.location.href = 'emp_datatable_list.php';
                }
            </script>
            <!-- JS Update -->
            <script>
            ...
            <script>
                function showResignModal() {
                    // Logika untuk menampilkan modal resign
                    console.log('Resign modal ditampilkan');
                }
                ...
                $('#resignModal .close').click(function() {
                ...
                $('#confirmResignButton').click(function() {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            window.location.href = 'emp_datatable_exit.php?resign-success=1';
                        },
                        error: function(xhr, status, error) {
